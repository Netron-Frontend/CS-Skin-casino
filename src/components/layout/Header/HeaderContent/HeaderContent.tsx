    ...
    <HeaderContentBox>
        <Container maxWidth="lg" sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', gap: '14px', alignItems: 'center', marginRight: 'auto', marginLeft: '68px'}}>
              ...
              <a href="#" style={{display: 'flex', justifyContent: 'space-between', gap: '3px', alignItems: 'center', fontSize: '12px', fontFamily: "Libre Franklin, sans-serif", fontOpticalSizing: 'auto', fontWeight: '400'}}><img style={{width: '24px', height: '24px'}} src="/Header/HeaderContent/ranks.svg" alt="ranks"/>Ranks</a>
              <a href="#" style={{display: 'flex', justifyContent: 'space-between', gap: '3px', alignItems: 'center', fontSize: '12px', fontFamily: "Libre Franklin, sans-serif", fontOpticalSizing: 'auto', fontWeight: '400'}}><img style={{width: '24px', height: '24px'}} src="/Header/HeaderContent/help.svg" alt="help"/>Help</a>
          </div>
          <div style={{display: 'flex', justifyContent: 'space-between', gap: '15px', alignItems: 'center'}}>
              ...
              <a  href="#"><img style={{width: '24px', height: '24px'}} src="/Header/HeaderContent/setting.svg" alt=""/></a>
          </div>
      </Container>
    </HeaderContentBox>
  )
