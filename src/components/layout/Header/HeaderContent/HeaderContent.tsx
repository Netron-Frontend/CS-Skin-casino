    ...
    <HeaderContentBox>
      <Container>
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', gap: '14px', alignItems: 'center', marginRight: 'auto', marginLeft: '68px'}}>
              ...
              <a href="#" style={{display: 'flex', justifyContent: 'space-between', gap: '3px', alignItems: 'center' }}><img style={{width: '24px', height: '24px'}} src="/HomePage/HeaderContent/gift.svg" alt="gift"/>Daily Free</a>
              <a href="#" style={{display: 'flex', justifyContent: 'space-between', gap: '3px', alignItems: 'center' }}><img style={{width: '24px', height: '24px'}} src="/HomePage/HeaderContent/ranks.svg" alt="ranks"/>Ranks</a>
              <a href="#" style={{display: 'flex', justifyContent: 'space-between', gap: '3px', alignItems: 'center' }}><img style={{width: '24px', height: '24px'}} src="/HomePage/HeaderContent/help.svg" alt="help"/>Help</a>
          </div>
